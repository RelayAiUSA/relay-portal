...
Extract job details and return ONLY valid JSON (no markdown, no explanation):
{
  ...
  "address": "",
  "amount": 0,
  "title": "3-6 word service title that specifically describes the work performed. Always derive the title from the actual job — never use a generic label like 'Repair', 'Service Call', or 'Job'. Capitalize each word, no punctuation. Examples by trade: plumbing: 'Toilet Removal and Disconnect', 'Water Heater Installation', 'Faucet Leak Repair'; electrical: 'Outlet Replacement', 'Panel Breaker Install', 'Ceiling Fan Wiring'; HVAC: 'AC Unit Inspection', 'Furnace Filter Replacement'; carpentry: 'Door Frame Repair', 'Deck Board Replacement'; painting: 'Interior Bedroom Paint', 'Exterior Trim Repaint'; landscaping: 'Lawn Mowing Service', 'Tree Trimming'; general: 'Drywall Patch and Finish', 'Gutter Cleaning'. Match the title to exactly what was dispatched.",
  "professional_description": "2-3 sentence professional description for the invoice. Use clean, trade-appropriate language and a professional tone throughout. Expand the technician's shorthand into readable prose — but every detail must come directly from the original dispatch message. Do not infer, assume, or add anything that was not stated. Whatever trade the job is in — plumbing, electrical, HVAC, carpentry, landscaping, or anything else — write only what was dispatched. Keep it factual, past-tense, and concise. Examples: 'removed toilet' → 'Removed and disconnected existing toilet from its connection points. Unit was cleared from the work area upon completion.' | 'replaced outlet' → 'Removed existing electrical outlet and installed new replacement unit. Connections were tested and confirmed functional.' | 'mowed lawn' → 'Performed lawn mowing service for the full property. Clippings were cleared upon completion.'",
  "confidence": 0.0
}
